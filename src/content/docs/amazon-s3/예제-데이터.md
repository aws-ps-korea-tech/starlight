...
[https://github.com/aws-samples/s3-select-phonebook-search/blob/master/src/test/resources/sample\_data.csv](https://github.com/aws-samples/s3-select-phonebook-search/blob/master/src/test/resources/sample_data.csv)
